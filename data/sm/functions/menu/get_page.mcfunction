...
execute if score bool ftboredersawmill matches 1 run scoreboard players set @s ftboredersawmill 0
...
execute if score bool ftboredersawmill matches 1 run scoreboard players set @s ftboredersawmill 1
...
execute if score bool ftboredersawmill matches 1 run scoreboard players set @s ftboredersawmill 2
